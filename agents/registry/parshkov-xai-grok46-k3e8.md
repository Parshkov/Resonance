...
- R2-EXTRACTION: cue-grounded context→ThoughtGraph plus manual bypass (`src/extraction/**`; PR #63); revision for independent review blockers (overlap merge, aligned edge F1, polarity scope, threshold validation, frozen coverage report)
